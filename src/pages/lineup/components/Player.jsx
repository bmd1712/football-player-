  ...
  return (
    <div className="flex gap-4 m-2 items-center">
      ...
      <div className="flex-1 w-full relative min-w-0 hover:scale-105  ">
        <p className="w-full truncate pr-8 font-bold bg-green-300 hover:bg-green-400  dark:bg-green-600 dark:hover:bg-green-400  p-2 rounded-lg"
          onClick={onEdit}>
          {name}</p>
        <button
          className="absolute flex-none top-3 right-2 text-white  hover:text-red-500 dark:hover:text-red-600 "
          onClick={(e) => {
